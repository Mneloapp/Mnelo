import { ClassificationReviewPrototype } from "@/components/classification-review-prototype";
import {
...
export default async function ProjectClassificationReviewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <WorkspaceShell active="Projects">
      <ProjectWorkspacePage>
        ...
        <ProjectWorkspacePanel
          description="Review AI classification decisions as groups, not as one-row-at-a-time edits."
          eyebrow="Prototype Only"
          title="AI Review"
        >
          <ClassificationReviewPrototype items={items} />
          {showBoqError ? (
