...
| `classification_source` | Source of the current classification: `rules`, `learned`, `ai`, `inherited_header`, or `needs_review`. |
...
After refresh, Intelligence views must treat `classification_source = 'learned'` as a user-confirmed override.
