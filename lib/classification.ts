...
const extraKeywordAliases = new Map<string, string[]>([
  ...
  ["Cable Trays", ["cable tray", "ladder tray", "wire mesh tray", "tray", "კაბელსატარი", "საკაბელო არხი", "საკაბელო ლოტოკი", "лоток", "кабельный лоток"]],
  ["Conduits", ["conduit", "flexible conduit", "corrugated pipe", "electrical pipe", "pvc pipe electrical", "ელექტრო მილი", "გოფრირებული მილი", "гофра", "труба электрическая"]],
