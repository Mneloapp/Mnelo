...
const extraKeywordAliases = new Map<string, string[]>([
  ...
  ["Conduits", ["conduit", "flexible conduit", "corrugated pipe", "electrical pipe", "pvc pipe electrical", "ელექტრო მილი", "გოფრირებული მილი", "გოფრირებული", "гофра", "труба электрическая"]],
  ["Flexible Conduits", ["flexible conduit", "corrugated pipe", "გოფრირებული მილი", "гофра"]],
