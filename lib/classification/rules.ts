...
const taxonomy = [
  ...
  },
  {
    ...
    categories: [
      ...
      {
        name: "Wiring Devices",
        subcategories: ["Sockets & Switches"],
      },
      {
        name: "Small Power",
      ...
      {
        name: "Panels",
        subcategories: ["Distribution Boards"],
      },
      {
      ...
      {
        name: "Cables",
        subcategories: ["Power & Control Cables"],
      },
      {
...
const extraKeywordAliases = new Map<string, string[]>([
  ...
  ["Fixtures", ["luminaire", "light fixture", "lighting fixture", "led panel", "led strip", "downlight", "spotlight", "projector", "emergency light", "batten lighting", "სანათი", "სანათები", "ავარიული სანათი", "светильник"]],
  ["Lighting Fixtures", ["luminaire", "light fixture", "lighting fixture", "led panel", "led strip", "downlight", "spotlight", "projector", "emergency light", "batten lighting", "სანათი", "სანათები", "ავარიული სანათი", "светильник"]],
  ...
  ["Fire Resistant Cables", ["fire resistant cable", "fire rated cable", "fr cable"]],
  ["Distribution Boards", ["distribution board", "panel board", "switchboard", "mdb", "db", "mcc", "გამანაწილებელი დაფა", "გამანაწილებელი ფარი", "ფარი", "ელექტრო ფარი", "щит", "распределительный щит"]],
  ["Main Distribution Boards", ["mdb", "mdbg", "main distribution"]],
  ["Sub Distribution Boards", ["ldb", "pdb", "fdb", "distribution panel"]],
  ["Cable Trays", ["cable tray", "ladder tray", "wire mesh tray", "tray", "კაბელსატარი", "კაბელსატარები", "საკაბელო არხი", "საკაბელო ლოტოკი", "лоток", "кабельный лоток"]],
  ["Conduits", ["conduit", "flexible conduit", "corrugated conduit", "corrugated pipe", "installation pipe", "electrical pipe", "pvc pipe electrical", "საინსტალაციო მილი", "ელექტრო მილი", "გოფრირებული მილი", "გოფრირებული", "гофра", "труба электрическая"]],
  ["Flexible Conduits", ["flexible conduit", "corrugated conduit", "corrugated pipe", "გოფრირებული მილი", "гофра"]],
  ["Junction Boxes", ["junction box", "j-box", "j box", "electrical junction box", "distribution box", "გამანაწილებელი კოლოფი", "ელექტრო კოლოფი", "junction коробка", "распаечная коробка"]],
  ["Sockets & Switches", ["socket", "outlet", "receptacle", "switch", "როზეტი", "ჩამრთველი", "розетка", "выключатель"]],
  ["Sockets", ["socket", "outlet", "receptacle", "როზეტი", "розетка"]],
  ["Switches", ["switch", "ჩამრთველი", "выключатель"]],
  ["Breakers", ["breaker", "circuit breaker", "mcb", "mccb", "rcd", "rcbo", "ავტომატი", "автомат", "выключатель автоматический"]],
...
const contextualSectionAliases = [
  ...
  { systemName: "Electrical", categoryName: "Panels", subcategoryName: "Distribution Boards", aliases: ["გამანაწილებელი დაფა", "გამანაწილებელი ფარები", "mdb", "mdbg", "ldb", "pdb", "fdb"] },
  { systemName: "Electrical", categoryName: "Cables", subcategoryName: "Power & Control Cables", aliases: ["კაბელები", "power cables", "control cables"] },
  ...
  { systemName: "Electrical", categoryName: "Containment", subcategoryName: "Conduits", aliases: ["საინსტალაციო მილი", "ელექტრო მილი", "გოფრირებული მილი", "conduit", "corrugated conduit", "installation pipe"] },
